...
namespace RalseiMod.Survivors.Ralsei
{
    public class RalseiSurvivor : SurvivorBase<RalseiSurvivor>
    {
        ...
        public override string SurvivorDescription => "Ralsei's support capabilities can rally together any team, friend or foe! " + Environment.NewLine + Environment.NewLine +
            ...
            "< ! > Casting Pacify on bosses can be a great way to soften them for minions to gain an advantage. " +
                "Don't dismiss it just because Pacify can't spare bosses. " + Environment.NewLine + Environment.NewLine +
            "< ! > Your primary is much stronger without the last hit of the combo, but cannot debuff without it. " +
        ...
        public override void InitializeSkills()
        {
            ...
            if (skillLocator != null)
            {
                ...
                skillLocator.passiveSkill = new SkillLocator.PassiveSkill
                {
                    ...
                    icon = assetBundle.LoadAsset<Sprite>("passive"),
                };
            }
            //add our own
